...
const WalletStatus = () => {
  ...
  if (account.isConnected) {
    return (
      <button className="max-h-12 digital text-sm tracking-widest gap-1 grow p-2 text-center border text-gold col-span-4 rounded-md flex items-center justify-center">
