...
import type {
  LSP8Enumerable,
  LSP8EnumerableInterface,
} from "../../../../../../@lukso/lsp-smart-contracts/contracts/LSP8IdentifiableDigitalAsset/extensions/LSP8Enumerable";
...
export class LSP8Enumerable__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8EnumerableInterface {
    return new Interface(_abi) as LSP8EnumerableInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LSP8Enumerable {
    return new Contract(address, _abi, runner) as unknown as LSP8Enumerable;
  }
}
